; minimOS 0.4a3 LED Keypad driver, 6502 SDx
...
led_no_bs:
	...
	BMI led_no_dot		; already has dot, go away
...
led_get:
	LDA #0		; NMOS only
	STA iorb	; disable digit - STZ, but should really do s_poke()
...
ledg_nwr:
	...
	STA iorb	; put it on PB, should do s_poke()
	LDA rowmask, X	; appropiate cathode-enabling masks for PA = 128, 64, 32, 16
	STA iora	; ...or s_poke()
	LDA iora	; get input bits from PA, maybe s_peek()?
...
led_reset:
	...
	STA ddra	; Eeeek! Should be thru s_poke(), really...
...
ledr_init:
	...
	STA led_len
	LDA pcr		; negate CB2 for display enable
	AND #$1F	; keep other PCR bits
	ORA #$C0	; CB2 low
	STA pcr		; enable display
	_EXIT_OK
