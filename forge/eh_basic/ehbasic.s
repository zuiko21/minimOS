...
; advance to end of header
	.dsb	ehHead + $F8 - *, $FF	; for ready-to-blow ROM, advance to time/date field

; *** date & time in MS-DOS format at byte 248 ($F8) ***
	.word	$6380					; time, 12.28
	.word	$4C98					; date, 2018/4/24

ehSize	=	ehEnd - ehHead -256	; compute size NOT including header!
...
LAB_13EC
	...
	SBC	#COLON			; subtract COLON (carry set by CMP #00)
	BEQ	LAB_13FF		; branch if it was COLON (is now $00)
...
; slowest (<COLON)	=  40 cycles =  21.7uS
...
LAB_2CF4
	...
	CMP	#COLON			; compare with COLON
	BCS	LAB_2D05		; exit if >= COLON, not numeric, carry set
...
ehEnd:					; for easier size computation
.)
