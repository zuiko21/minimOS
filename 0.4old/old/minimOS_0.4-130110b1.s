...
init_via:
	...
	STA _VIA+ier
	LDA #$35		; $C35 = 200 Hz interrupt @ 1.25 MHz, try another initial value...
...
acia_poll:
	JMP (drv_acia+d_poll)	; this should point to RTS (no polling)
lcd_poll:
...
led_req:
	JMP (drv_led+d_req)	; should be from table, but this will point to RTS (can't generate IRQs)
acia_req:
