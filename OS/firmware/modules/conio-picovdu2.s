; firmware module for picoVDU (new 8 kiB design)
; 32x32 text b&w
...
cio_bel:
; * * BEL, make a beep! * * *** *** TBD *** *** new beeper port as virtual P27 ***
...
; * * cursor up * * no big deal, will stop at top row (NMOS savvy, always 23b and 39t)
	...
	BPL do_cup
		JSR draw_cur		; ...must delete previous one
do_cup:
	LDA #%00011111			; complete mask, just for the offset, independent of screen-block
...
; *******************************
; *** some multibyte routines *** CONTINUE HERE *** *** CONTINUE HERE *** **
; *******************************
