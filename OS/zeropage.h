; minimOS 0.6a7 zero-page system variables
; (c) 2012-2017 Carlos J. Santisteban
; last modified 20170822-1601
...
b_ram	= ma_rs+3			; Banks of "high" memory (65816 only)
...
c_speed	= cpu_ll+1
up_sec	= up_ticks+1		; new source-compatible format
