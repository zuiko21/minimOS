...
#define		_MACHINE_NAME	"SDd PLUS"
#define		_MACHINE_ID		"sdd+"

;ROM_BASE	=	$F000	; 4 kiB ROM SDd/Chihuahua
ROM_BASE	=	$8000	; SDx, SDd+/Chihuahua PLUS only, maybe MTE too
...
ACIA	=	$6FE0		; SDd+, maybe
;ACIA	=	$DFE0		; ACIA address on SDx and most other
...
SP		=	$63		; (previously $75) MTE and other 128-byte systems have 128-byte RAM!
